...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/ravishaggarwal/Desktop/cs_itw/by/by_case/ml_test/production-model-package/.tox/test_package'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/ravishaggarwal/Desktop/cs_itw/by/by_case/ml_test/production-model-package/.tox/test_package/bin/deactivate.nu'
